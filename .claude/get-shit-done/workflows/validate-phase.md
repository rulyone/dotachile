...
```
Task(
  prompt="Read /Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/templates/VALIDATION.md`
