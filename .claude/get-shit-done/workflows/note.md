...
- **Global scope**: `/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/notes/`)
...
2. Glob `/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/notes/` — works in any directory
