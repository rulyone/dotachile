...
Key references:
- @/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/USER-PROFILE.md" "/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/CLAUDE.md
```
