...
- Usage: Reference from command with `@/Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/pmartinez/Documents/git/quantumentangled/dotachile/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
